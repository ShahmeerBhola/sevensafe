        ...
        <div className="gx-profile-banner-top">
          <div className="gx-profile-banner-top-left">
            ...
            <div className="gx-profile-banner-avatar-info">
              <h2 className="gx-mb-2 gx-mb-sm-3 gx-fs-xxl gx-font-weight-light">{userData.first_name+" "+userData.last_name}</h2>
              <p className="gx-mb-0 gx-fs-lg">{userData.state?.name}, USA</p>
            </div>
          </div>
          <div className="gx-profile-banner-top-right">
            <ul className="gx-follower-list">
              <li>
                <span className="gx-follower-title gx-fs-lg gx-font-weight-medium">{userData.zip_code}</span>
                <span className="gx-fs-sm">Zip Code</span></li>
              <li>
                <span className="gx-follower-title gx-fs-lg gx-font-weight-medium">{userData.city?.name}</span>
                <span className="gx-fs-sm">City</span></li>
              <li>
                <span className="gx-follower-title gx-fs-lg gx-font-weight-medium">{userData.state?.name}</span>
                <span className="gx-fs-sm">State</span>
              </li>
            </ul>
          </div>
        </div>
